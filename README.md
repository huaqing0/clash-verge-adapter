...
> [!IMPORTANT]
> This repository is the Clash Control Adapter fork of Clash Verge Rev
> `v2.5.1`. It adds a loopback-only, authenticated API used by
> [Clash Control MCP](https://github.com/huaqing0/clash-control-mcp) for native
> Profile and Verge-preference operations. See
> [CLASH-CONTROL-ADAPTER.md](./CLASH-CONTROL-ADAPTER.md) for scope, security
> boundaries, compatibility, and build status.
>
> This source repository intentionally has no scheduled or multi-platform
> release workflows. It does not publish a replacement Clash Verge client.
